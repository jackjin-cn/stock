...
class stock:
    ...
    def display(self):
        ...
        self.result_string=self.result_string+"{:>6.2f}({:<6.2f}) {:5.2f} {:5.2f}%".format(self.stock['now'],self.stock['max'],self.stock['range'],self.stock['range_percent'])
...
app=wx.App()
mytitle=u"'JJB' stock analisy system V1.04 "+u'(2015-06-02)'
w_weight=850
w_height=150
s_height=20
